 ...
 */
var getData$1 = !metaMap ? noop$1 : function(func) {
...
function baseIsEqualDeep(object, other, bitmask, customizer, equalFunc, stack) {
  ...
  if (!(bitmask & COMPARE_PARTIAL_FLAG$3)) {
    var objIsWrapped = objIsObj && hasOwnProperty$16.call(object, '__wrapped__'),
        othIsWrapped = othIsObj && hasOwnProperty$16.call(other, '__wrapped__');
...
function debounce(func, wait, options) {
  ...
  if (isObject$1(options)) {
    ...
    maxWait = maxing ? nativeMax$5(toNumber$1(options.maxWait) || 0, wait) : maxWait;
...
var defaults = baseRest(function(object, sources) {
  ...
  while (++index < length) {
    ...
    while (++propsIndex < propsLength) {
      ...
      if (value === undefined ||
          (eq(value, objectProto$20[key]) && !hasOwnProperty$18.call(object, key))) {
...
/* Built-in method references for those with the same name as other `lodash` methods. */
var nativeReverse = arrayProto$5.reverse;
...
/** Used to check objects for own properties. */
var hasOwnProperty$23 = objectProto$26.hasOwnProperty;
...
function customDefaultsAssignIn(objValue, srcValue, key, object) {
  if (objValue === undefined ||
      (eq(objValue, objectProto$26[key]) && !hasOwnProperty$23.call(object, key))) {
    return srcValue;
  }
  return objValue;
}
 ...
 */
var createSet = !(Set$1 && (1 / setToArray(new Set$1([,-0]))[1]) == INFINITY$5) ? noop$1 : function(values) {
...
var array = {
  chunk, compact, concat: concat$1, difference, differenceBy,
  differenceWith, drop, dropRight, dropRightWhile, dropWhile,
  fill, findIndex, findLastIndex, first: head, flatten,
  flattenDeep, flattenDepth, fromPairs, head, indexOf,
  initial, intersection, intersectionBy, intersectionWith, join,
  last, lastIndexOf, nth, pull, pullAll,
  pullAllBy, pullAllWith, pullAt, remove: remove$3, reverse,
...
var lang = {
  ...
  isNative: isNative$1, isNil, isNull, isNumber, isObject: isObject$1,
  isObjectLike, isPlainObject: isPlainObject$1, isRegExp: isRegExp$1, isSafeInteger, isSet,
  isString, isSymbol, isTypedArray, isUndefined, isWeakMap,
  isWeakSet, lt, lte, toArray: toArray$1, toFinite,
  toInteger, toLength, toNumber: toNumber$1, toPlainObject, toSafeInteger,
  toString: toString$1
};
...
var object = {
  ...
  get, has: has$1, hasIn, invert, invertBy,
...
var string = {
  camelCase, capitalize: capitalize$1, deburr, endsWith, escape,
  escapeRegExp, kebabCase, lowerCase, lowerFirst, pad,
  padEnd, padStart, parseInt: parseInt$1, repeat: repeat$1, replace,
...
var util = {
  ...
  matches: matches$1, matchesProperty, method, methodOf, mixin,
...
/** Used to check objects for own properties. */
var hasOwnProperty$24 = objectProto$27.hasOwnProperty;
...
mixin$2(lodash, (function() {
  ...
  baseForOwn(lodash, function(func$$1, methodName) {
    if (!hasOwnProperty$24.call(lodash.prototype, methodName)) {
...
arrayEach(['pop', 'push', 'shift', 'sort', 'splice', 'unshift'], function(methodName) {
  var func$$1 = arrayProto$6[methodName],
...
function format(date) {
    ...
    var values = get_date_values(date).map(function (d) {
        return padStart$2(d, 2, 0);
    });
    var format_map = {
        YYYY: values[0],
        MM: padStart$2(+values[1] + 1, 2, 0),
        DD: values[2],
        HH: values[3],
        mm: values[4],
        ss: values[5],
...
function start_of(date, scale) {
    ...
    var scores = (_scores = {}, defineProperty$2(_scores, YEAR, 6), defineProperty$2(_scores, MONTH, 5), defineProperty$2(_scores, DAY, 4), defineProperty$2(_scores, HOUR, 3), defineProperty$2(_scores, MINUTE, 2), defineProperty$2(_scores, SECOND, 1), defineProperty$2(_scores, MILLISECOND, 0), _scores);
...
function clone$2(date) {
    return new (Function.prototype.bind.apply(Date, [null].concat(toConsumableArray(get_date_values(date)))))();
}
...
var _marked = /*#__PURE__*/regeneratorRuntime.mark(scale_generator);

function scale_generator(start, end, step) {
    var unit = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'hour';
    var cur_date;
    return regeneratorRuntime.wrap(function scale_generator$(_context) {
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    cur_date = clone$2(start);
                ...
                case 1:
                    ...
                    _context.next = 4;
                    return cur_date = add$4(cur_date, step, unit);
...
var scales = {
    'Quarter Day': {
        step: 24 / 4,
        column_width: 38,
        pad_start: function pad_start(start) {
            return add$4(start, -7, 'day');
        },
        pad_end: function pad_end(end) {
            return add$4(end, 7, 'day');
        },
        ticks: function ticks(start, end) {
            return [start].concat(toConsumableArray(scale_generator(start, end, 24 / 4)));
        },
        tick_width_multiplier: function tick_width_multiplier() {
            return 1;
        },
        thick_tick: function thick_tick() {
            return false;
        },
        tick_lower: function tick_lower(date) {
            return format(date, 'HH');
        },
        tick_upper: function tick_upper(date, last_date) {
            return date.getDate() !== last_date.getDate() ? format(date, 'D MMM') : '';
        },
        tick_lower_multiplier: 4,
        tick_upper_multiplier: 0,
        offset_x: function offset_x(datea, dateb) {
            return diff(datea, dateb, 'hour') / (24 / 4) * 38;
        },
        offset_to_date: function offset_to_date(start, x) {
            return add$4(start, x / 38 * (24 / 4), 'hour');
        }
    },
    'Half Day': {
        step: 24 / 2,
        ...
        ticks: function ticks(start, end) {
            return [start].concat(toConsumableArray(scale_generator(start, end, 24 / 2)));
        },
        tick_width_multiplier: function tick_width_multiplier() {
            return 1;
        },
        ...
        tick_upper: function tick_upper(date, last_date) {
            return date.getDate() !== last_date.getDate() ? date.getMonth() !== last_date.getMonth() ? format(date, 'D MMM') : format(date, 'D') : '';
        },
        tick_lower_multiplier: 2,
        tick_upper_multiplier: 0,
        offset_x: function offset_x(datea, dateb) {
            return diff(datea, dateb, 'hour') / (24 / 2) * 38;
        },
        offset_to_date: function offset_to_date(start, x) {
            return add$4(start, x / 38 * (24 / 2), 'hour');
        }
    },
    Day: {
        step: 24,
        column_width: 38,
        pad_start: function pad_start(start) {
            return add$4(start, -1, 'month');
        },
        pad_end: function pad_end(end) {
            return add$4(end, 1, 'month');
        },
        ticks: function ticks(start, end) {
            return [start].concat(toConsumableArray(scale_generator(start, end, 24)));
        },
        tick_width_multiplier: function tick_width_multiplier() {
            return 1;
        },
        thick_tick: function thick_tick(tick) {
            return tick.getDate() === 1;
        },
        tick_lower: function tick_lower(date, last_date) {
            return date.getDate() !== last_date.getDate() ? format(date, 'D') : '';
        },
        tick_upper: function tick_upper(date, last_date) {
            return date.getMonth() !== last_date.getMonth() ? format(date, 'MMMM') : '';
        },
        tick_lower_multiplier: 1,
        tick_upper_multiplier: 30,
        offset_x: function offset_x(datea, dateb) {
            return diff(datea, dateb, 'hour') / 24 * 38;
        },
        offset_to_date: function offset_to_date(start, x) {
            return add$4(start, x / 38 * 24, 'hour');
        }
    },
    Week: {
        step: 24 * 7,
        ...
        ticks: function ticks(start, end) {
            return [start].concat(toConsumableArray(scale_generator(start, end, 24 * 7)));
        },
        tick_width_multiplier: function tick_width_multiplier() {
            return 1;
        },
        thick_tick: function thick_tick(tick) {
            return tick.getDate() >= 1 && tick.getDate() < 8;
        },
        tick_lower: function tick_lower(date, last_date) {
            return date.getMonth() !== last_date.getMonth() ? format(date, 'D MMM') : format(date, 'D');
        },
        tick_upper: function tick_upper(date, last_date) {
            return date.getMonth() !== last_date.getMonth() ? format(date, 'MMMM') : '';
        },
        ...
        offset_x: function offset_x(datea, dateb) {
            return diff(datea, dateb, 'hour') / (24 * 7) * 140;
        },
        offset_to_date: function offset_to_date(start, x) {
            return add$4(start, x / 140 * 24 * 7, 'hour');
        }
    },
    Month: {
        step: 24 * 30,
        column_width: 120,
        pad_start: function pad_start(start) {
            return start_of(start, 'year');
        },
        pad_end: function pad_end(end) {
            return add$4(end, 1, 'year');
        },
        ticks: function ticks(start, end) {
            return [start].concat(toConsumableArray(scale_generator(start, end, 1, 'month')));
        },
        tick_width_multiplier: function tick_width_multiplier(tick) {
            return get_days_in_month(tick) / 30;
        },
        thick_tick: function thick_tick(tick) {
            return (tick.getMonth() + 1) % 3 === 0;
        },
        tick_lower: function tick_lower(date) {
            return format(date, 'MMMM');
        },
        tick_upper: function tick_upper(date, last_date) {
            return date.getFullYear() !== last_date.getFullYear() ? format(date, 'YYYY') : '';
        },
        tick_lower_multiplier: 1,
        tick_upper_multiplier: 12,
        offset_x: function offset_x(datea, dateb) {
            return diff(datea, dateb, 'day') / 30 * 120;
        },
        offset_to_date: function offset_to_date(start, x) {
            return add$4(start, x / 120 * 30, 'day');
        }
    }
};

var GanttGridRows = { render: function render() {
        var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('g', [_vm._l(_vm.rowcount, function (row, row_index) {
            return _c('rect', { staticClass: "grid-row", attrs: { "x": "0", "width": _vm.sizing.grid_width, "height": _vm.height, "y": _vm.y(row_index) } });
        }), _vm._v(" "), _vm._l(_vm.rowcount, function (row, row_index) {
            return _c('rect', { staticClass: "row-line", attrs: { "x1": "0", "x2": _vm.sizing.grid_width, "y1": _vm.y(row_index) + _vm.height, "y2": _vm.y(row_index) + _vm.height } });
        })], 2);
    }, staticRenderFns: [],
    props: ['rowcount', 'sizing'],
    computed: {
        height: function height(vm) {
            return vm.sizing.bar_height + vm.sizing.padding;
        },
        y: function y(vm) {
            return function (row_index) {
                return vm.sizing.header_height + vm.sizing.padding / 2 + row_index * (vm.sizing.bar_height + vm.sizing.padding);
            };
        }
    }
};

var GanttGridColumns = { render: function render() {
        var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('g', [_vm._l(_vm.ticks, function (tick, index) {
            return _c('path', { class: ['tick', { thick: _vm.scale.thick_tick(tick) }], attrs: { "d": 'M ' + _vm.x(index) + ' ' + _vm.y + ' v ' + _vm.height } });
        }), _vm._v(" "), _vm.view_mode === 'Day' ? _c('rect', { staticClass: "today-highlight", attrs: { "x": _vm.today_x, "y": "0", "width": _vm.sizing.column_width, "height": _vm.highlight_height } }) : _vm._e()], 2);
    }, staticRenderFns: [],
    props: ['ticks', 'view_mode', 'sizing', 'scale', 'start'],
    computed: {
        y: function y(vm) {
            return vm.sizing.header_height + vm.sizing.padding / 2;
        },
        width: function width(vm) {
            return function (tick) {
                return vm.scale.tick_width_multiplier(tick) * vm.sizing.column_width;
            };
        },
        x: function x(vm) {
            return function (index) {
                return vm.ticks.slice(0, index).map(vm.width).reduce(function (total, width) {
                    return total + width;
                }, 0);
            };
        },
        height: function height(vm) {
            return vm.sizing.grid_height - (vm.sizing.header_height + vm.sizing.padding);
        },
        highlight_height: function highlight_height(vm) {
            return vm.sizing.grid_height - vm.sizing.padding + 10;
        },

        today_x: function today_x(vm) {
            return vm.scale.offset_x(today(), vm.start);
        }
    }
};

var GanttTick = { render: function render() {
        var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('g', [_c('text', { staticClass: "lower-text", attrs: { "x": _vm.lower_x, "y": _vm.lower_y } }, [_vm._v(_vm._s(_vm.lower_text))]), _vm._v(" "), _vm.upper_text ? _c('text', { staticClass: "upper-text", attrs: { "x": _vm.upper_x, "y": _vm.upper_y } }, [_vm._v(" " + _vm._s(_vm.upper_text) + " ")]) : _vm._e()]);
    }, staticRenderFns: [],
    props: ['tick', 'last_tick', 'index', 'sizing', 'scale'],
    computed: {
        lower_x: function lower_x(vm) {
            return vm.index * vm.sizing.column_width + vm.sizing.column_width * vm.scale.tick_lower_multiplier / 2;
        },
        lower_y: function lower_y(vm) {
            return vm.sizing.header_height;
        },
        lower_text: function lower_text(vm) {
            return vm.scale.tick_lower(vm.tick, vm.last_tick);
        },

        upper_x: function upper_x(vm) {
            return vm.index * vm.sizing.column_width + vm.sizing.column_width * vm.scale.tick_upper_multiplier / 2;
        },
        upper_y: function upper_y(vm) {
            return vm.sizing.header_height - 25;
        },
        upper_text: function upper_text(vm) {
            return vm.scale.tick_upper(vm.tick, vm.last_tick);
        }
    }
};

var GanttBar = { render: function render() {
        var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('g', { class: ['bar-wrapper', _vm.task.custom_class], attrs: { "data-id": _vm.task.id }, on: { "mousedown": _vm.drag } }, [_c('g', { staticClass: "bar-group" }, [_c('rect', _vm._b({ staticClass: "bar" }, 'rect', { x: _vm.x, y: _vm.y, width: _vm.width, height: _vm.height, rx: _vm.bar_corner_radius, ry: _vm.bar_corner_radius }, false)), _vm._v(" "), _c('rect', _vm._b({ class: ['bar-progress', { completed: _vm.progress === 100 }] }, 'rect', { x: _vm.x, y: _vm.y, width: _vm.progress_width, height: _vm.height, rx: _vm.bar_corner_radius, ry: _vm.bar_corner_radius }, false)), _vm._v(" "), _c('text', { class: ['bar-label', { big: _vm.big_label }], attrs: { "x": _vm.text_x, "y": _vm.y + _vm.height / 2 } }, [_vm._v(_vm._s(_vm.task.changes.label || _vm.task.name))])]), _vm._v(" "), _c('g', { staticClass: "handle-group" }, [_c('rect', _vm._b({ staticClass: "handle right", on: { "mousedown": _vm.resize_right } }, 'rect', {
            ...
            height: _vm.height - 2,
            rx: _vm.bar_corner_radius,
            ry: _vm.bar_corner_radius }, false)), _vm._v(" "), _c('polygon', { staticClass: "handle progress", attrs: { "points": [_vm.x + _vm.progress_width - 5, _vm.y + _vm.height, _vm.x + _vm.progress_width + 5, _vm.y + _vm.height, _vm.x + _vm.progress_width, _vm.y + _vm.height - 8.66].join(',') }, on: { "mousedown": _vm.resize_progress } })])]);
    }, staticRenderFns: [],
    ...
    computed: {
        ...
        progress: function progress(vm) {
            return vm.task.changes.progress != null ? vm.task.changes.progress : vm.task.progress;
        },
        progress_width: function progress_width(vm) {
            return vm.width * (vm.progress / 100) || 0;
        },
        text_x: function text_x(vm) {
            return vm.big_label ? vm.x + vm.width + 5 : vm.x + vm.width / 2;
        }
    },
    methods: {
        check_label: function check_label() {
            var _this = this;

            this.$nextTick(function () {
                var label = _this.$el.querySelector('.bar-label');
                _this.big_label = label.getBBox().width + _this.sizing.padding * 2 > _this.width;
            });
        },
        ...
        resize_progress: function resize_progress() {
            this.drag_action = 'progress';
        },
        ...
        dragging: function dragging(val) {
            if (this.drag_action) {
                if (val) {
                    ...
                    this.$emit('change', { id: id, x: x, width: width, progress: progress, label: label });
                } else {
                    ...
                    this.$emit('persist', { id: this.task.id, start: start, end: end, progress: this.progress });
                }
            }
        }
    },
...
var GanttArrow = { render: function render() {
    ...
    computed: {
        ...
        sx: function sx() {
            ...
            var furthest_right = this.fx + this.fw - this.sizing.padding;
...
var GanttVue = { render: function render() {
    ...
    computed: {
        ...
        grid_height: function grid_height(vm) {
            return vm.header_height + vm.padding + (vm.bar_height + vm.padding) * vm.rowcount;
        },

        scale: function scale(vm) {
            return _extends({}, scales[vm.view_mode]);
        },

        raw_start: function raw_start(vm) {
            return vm.tasks.map(function (t) {
                return t.start;
            }).reduce(function (earliest, start) {
                return start < earliest ? start : earliest;
            });
        },
        raw_end: function raw_end(vm) {
            return vm.tasks.map(function (t) {
                return t.end;
            }).reduce(function (latest, end) {
                return end > latest ? end : latest;
            });
        },
        start: function start(vm) {
            return vm.scale.pad_start(vm.raw_start);
        },
        end: function end(vm) {
            return vm.scale.pad_end(vm.raw_end);
        },
        ticks: function ticks(vm) {
            return vm.scale.ticks(vm.start, vm.end);
        },
        grid_width: function grid_width(vm) {
    ...
    methods: {
        horizontal_scroll: function horizontal_scroll() {
            var hours_before_first_task = diff(this.raw_start, this.start, 'hour');
